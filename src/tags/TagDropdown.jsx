 ...
 */
const TagDropdown = ({ suggestions, inputValue, onSelect, onCreate, currentTags = [], position }) => {
    ...
    return (
        <div
            className="absolute z-50 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg shadow-lg max-h-48 overflow-y-auto min-w-[200px]"
            style={{
